class PlaysController < ApplicationController
  ...
  def index
    @easy_plays = get_and_order_plays(filter_plays_by_difficulty(Play.all, "easy"))
    @medium_plays = get_and_order_plays(filter_plays_by_difficulty(Play.all, "medium"))
    @hard_plays = get_and_order_plays(filter_plays_by_difficulty(Play.all, "hard"))
